...
public class Fruit extends Food {
    ...
    public Fruit(int foodLevel, int pointsGained) {
        super(foodLevel, 30, pointsGained, "Fruit", 'f', true);
        this.rotTurn = 15;
        this.setPrice(30);
     ...
     */
    public int getExpiryTurns() { return rotTurn; }
     ...
     */
    public void setExpiryTurns(int rotTurn) { this.rotTurn = rotTurn; }
